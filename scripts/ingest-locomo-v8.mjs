#!/usr/bin/env node
/**
 * LOCOMO Extraction v8 - Extended predicate coverage
 */
...
// Extended predicate mapping
const QUESTION_PATTERNS = [
  // Temporal
  { patterns: ['when did', 'when was', 'what year', 'what date', 'what time'], predicate: 'qa_temporal', pds: '4101', domain: '4000' },
  ...
  { patterns: ['personality', 'trait'], predicate: 'qa_traits', pds: '1204', domain: '1000' },
  { patterns: ['age', 'how old'], predicate: 'qa_age', pds: '1202', domain: '1000' },
  
  // Likes/Preferences
  { patterns: ['what activities', 'what do', 'like to do'], predicate: 'qa_activities', pds: '1401', domain: '1000' },
  { patterns: ['what', 'like', 'prefer', 'enjoy', 'favorite'], predicate: 'qa_likes', pds: '1401', domain: '1000' },
  ...
  { patterns: ['paint', 'art', 'painted'], predicate: 'qa_art', pds: '1406', domain: '1000' },
  ...
  { patterns: ['what did'], predicate: 'qa_what', pds: '0000', domain: '000' },
];
...
async function main() {
  console.log('=== LOCOMO Extraction v8 (Extended Predicates) ===\n');
